...
SAFE_CONTRACT_REASONS = frozenset(
    {
        ...
        "editorial_headline_type",
        "editorial_headline_empty",
        "editorial_headline_too_long",
        "editorial_entry_type",
        "editorial_entry_empty",
        "editorial_supporting_points_type",
        "editorial_supporting_points_count",
        "editorial_supporting_point_type",
        "verdict",
        "issues",
        "reviewed_entry",
    }
