...
class ModelProfileTest(unittest.TestCase):
    def test_registry_resolves_legacy_alias_and_artifact_profiles(self) -> None:
        ...
        self.assertEqual(production.production_contract, "editorial_entry_v3")
        ...
        self.assertEqual(resolve_model_profile("gptoss120b", registry).comparison_contract, "editorial_entry_v3")
